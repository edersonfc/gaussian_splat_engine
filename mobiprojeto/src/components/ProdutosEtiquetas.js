...
import { View, Text, SafeAreaView, Alert, Image, TouchableOpacity, Dimensions, RefreshControl } from 'react-native';
  ...
  */
  ...
  return (
    ...
    <SafeAreaView style={[Estilo.App]} >
      ...
      {/*PAINEL DOS PRODUTOS INSERIDO AUTOMATICO ABAIXO*/}

      { //visibilidade ?
        produtosss.map((produtos, index) => (
          ...
          etiqueta_visivel_true_false_array[index] && (
            ...
            <View name={"PAI" + index} key={"PAI" + index} style={[style = { flexDirection: 'row', width: '100%', height: 150, borderWidth: 5, borderColor: '#fff', borderRadius: 20, backgroundColor: 'white', marginBottom: 10 }]}>
              ...
              <View style={[style = { width: '40%', padding: 0, borderWidth: 1, borderRadius: 20 }]} >
              ...
              <View style={[Estilo.borda_geral, style = { width: '60%', padding: 5, height: 120, borderWidth: 1, borderColor: 'red' }, Estilo.borda_geral]}>
                ...
                <View style={[Estilo.borda_geral, style = { height: 28, flexDirection: 'row', width: '100%' }]} >
                  ...
                  <View style={[Estilo.borda_geral, style = { height: 28, width: '70%' }]} >
                    ...
                    <Text style={[Estilo.fontePequena_produto_titulos, style = { borderWidth: 0 }]} >{/*produtos.titulo*/}Preços</Text>
                  </View>
                    ...
                    {VERIFICA_SE_A_POSTAGEM_E_DO_PROPRIO_USUARIO(index) ?
                      ...
                      <Icon
                        ...
                        onPress={(e) => {
                          ...
                          var numero_telefone = produtosss[index].numero_telefone_J;
                          var id_da_postagem = produtosss[index].id_J;
                      ...
                      <Icon name='trash-o'
                        ...
                        onPress={() => {
                          ...
                          ////////////////////////////////////////////////////////////////////////////////////////////////////
                          ////////////////////////////////////////////////////////////////////////////////////////////////////
                          var CELULAR_COMPRADOR_OU_VENDEDOR = produtosss[index].numero_telefone_J;
                          var ID_DA_POSTAGEM = produtosss[index].id_J;
      ...
      {/*PAINEL DOS PRODUTOS INSERIDO AUTOMATICO ACIMA*/}
