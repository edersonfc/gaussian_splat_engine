...
export default function Postar(props) {
    ...
    */
            ...
            for (var i = 0; i < obj_JSON.length; i++) {
                ...
                if (tamanho == 0) {
                    ...
                    ARRAY_VIDEOS.map((video, index) => {
                        let nome_do_arquivo = (extrair_nome_de_Arquivo_da_url(ARRAY_VIDEOS[index]).arquivo);
                    ...
                    await Axios.get(IP_DO_SERVIDOR + 'insert_postagens', {
                        ...
                        params: { postagem: JSON_POSTAGEM_STRING }
                    });
    ...
    const [nameBtbPostar, setNameBtbPostar] = useState("Postar");
    ...
    return (
        ...
        <SafeAreaView style={[Estilo.App]}    >
            ...
            <View style={{ flexDirection: 'row', width: '100%', height: 45, alignItems: 'center', justifyContent: 'flex-end', borderWidth: 0, borderColor: 'darkred' }} >
                ...
                {/** APAGAR DEPOIS ABAIXO COMPONENTE PROVISÓRIO ABAIXO **
                <TouchableOpacity style={{ flexDirection: 'row', width: '15%', height: 40, paddingLeft: 10, paddingBottom: 0, alignItems: 'center', justifyContent: 'flex-start', borderWidth: 0, borderColor: 'pink' }}
                    onPress={() => {

                        alert(VARIAVEL_GLOBAL.URL_VIDEOS_DURANTE_POSTAGENS.length);

                    }}>
                    <Icon name='eye' style={[Estilo.icones_medio]} />
                </TouchableOpacity>
                ** APAGAR DEPOIS ACIMA COMPONENTE PROVISÓRIO ACIMA **/}
                ...
                <View style={{ width: '99%', height: 1000, borderWidth: 0, borderColor: 'yellow' }} >
                    ...
                    <View style={{ width: '100%', paddingTop: 10, borderWidth: 0, borderColor: 'white', alignContent: 'center', alignItems: 'center' }}>
                        <TextInput style={{ width: LARGURA_DESCRICAO, minHeight: 45, backgroundColor: 'white', borderRadius: 8 }}
                            ...
                            onChangeText={
                                value => { descricoesGeraisF(value) }
                            }
                            value={descricoesGerais}
                    ...
                    <View style={{ width: '100%', height: 'auto', alignItems: 'center', alignContent: 'center', borderWidth: 0, borderColor: 'green' }} >
                            ...
                            onPress={async () => {
                                ...
                                if (nameBtbPostar == "Postar") {
                                    ...
                                    if (
                                        ...
                                        !URL_VIDEOS.toUpperCase().includes(".MP4")  // TROCADO PELA LINHA ABAIXO 03092021
                                        // !VARIAVEL_GLOBAL.URL_VIDEOS_DURANTE_POSTAGENS.toUpperCase().includes(".MP4")
                                    ) {
                                    ...
                                    setcor_12_24(false);
                                    setcor_24_36(false);
                                    setcorAcima_36(false);

                                    setcorBezerros(false);
                                    setcorGarrotes(false);
                                    setcorTourunos(false);
                                    setcorBois(false);
                                    setcorBoisGordos(false);

                                    setcorBezerras(false);
                                    setcorNovilhas(false);
                                    setcorVacasBoiadeiras(false);
                                    setcorVacas(false);
                                    setcorVacasGordas(false);
                                    setcorVacasPrenhas(false);
                                    setcorVacasParidas(false);

                                    outrasErasAnteriorF("");
                                    outrasErasPosteriorF("");
                                    descricoesGeraisF("");
                                    precoSugeridoF("");
                                    quantidadeCabecasOuPesosF(0);
                        ...
                        >
                            <Text style={{ fontSize: 15, color: '#fff' }} >{nameBtbPostar}</Text>
                        </TouchableHighlight>
    ...
    async function ARMAZENAR_POSTAGEM_PRIMEIRA_ETAPA() {
        ...
        let URL_VIDEOS_DADOS = "";  // ALTERADO PARA let  03092021
        // for (var i = 0; i < ARRY_URL_IMAGENS.length; i++) {
        for (var i = 0; i < VARIAVEL_GLOBAL.LISTAIMAGENS_CONTEXT.length; i++) {
        ...
        let URL_VIDEOS_DADOS_J = URL_VIDEOS_DADOS;
        ...
        VARIAVEL_GLOBAL.PRODUTO_JSON_SENDO_MANIPULADO_ATUALMENTE =
        {
            ...
            URL_VIDEOS_DADOS_J: URL_VIDEOS_DADOS_J, // ALTERADO 03092021
